...
INDTEXT_DATA bacnet_property_names[] = {
    ...
    { PROP_ACKED_TRANSITIONS, "acked_transitions" },
    { PROP_ACK_REQUIRED, "ack_required" },
    { PROP_ACTION, "action" },
    { PROP_ACTION_TEXT, "action_text" },
    { PROP_ACTIVE_TEXT, "active_text" },
    { PROP_ACTIVE_VT_SESSIONS, "active_vt_sessions" },
    { PROP_ALARM_VALUE, "alarm_value" },
    { PROP_ALARM_VALUES, "alarm_values" },
    { PROP_ALL, "all" },
    { PROP_ALL_WRITES_SUCCESSFUL, "all_writes_successful" },
    { PROP_APDU_SEGMENT_TIMEOUT, "apdu_segment_timeout" },
    { PROP_APDU_TIMEOUT, "apdu_timeout" },
    { PROP_APPLICATION_SOFTWARE_VERSION, "application_software_version" },
    { PROP_ARCHIVE, "archive" },
    { PROP_BIAS, "bias" },
    { PROP_CHANGE_OF_STATE_COUNT, "change_of_state_count" },
    { PROP_CHANGE_OF_STATE_TIME, "change_of_state_time" },
    { PROP_NOTIFICATION_CLASS, "notification_class" },
    { PROP_BLANK_1, "deleted_in_135_2001" },
    { PROP_CONTROLLED_VARIABLE_REFERENCE, "controlled_variable_reference" },
    { PROP_CONTROLLED_VARIABLE_UNITS, "controlled_variable_units" },
    { PROP_CONTROLLED_VARIABLE_VALUE, "controlled_variable_value" },
    { PROP_COV_INCREMENT, "cov_increment" },
    { PROP_DATE_LIST, "date_list" },
    { PROP_DAYLIGHT_SAVINGS_STATUS, "daylight_savings_status" },
    { PROP_DEADBAND, "deadband" },
    { PROP_DERIVATIVE_CONSTANT, "derivative_constant" },
    { PROP_DERIVATIVE_CONSTANT_UNITS, "derivative_constant_units" },
    { PROP_DESCRIPTION, "description" },
    { PROP_DESCRIPTION_OF_HALT, "description_of_halt" },
    { PROP_DEVICE_ADDRESS_BINDING, "device_address_binding" },
    { PROP_DEVICE_TYPE, "device_type" },
    { PROP_EFFECTIVE_PERIOD, "effective_period" },
    { PROP_ELAPSED_ACTIVE_TIME, "elapsed_active_time" },
    { PROP_ERROR_LIMIT, "error_limit" },
    { PROP_EVENT_ENABLE, "event_enable" },
    { PROP_EVENT_STATE, "event_state" },
    { PROP_EVENT_TYPE, "event_type" },
    { PROP_EXCEPTION_SCHEDULE, "exception_schedule" },
    { PROP_FAULT_VALUES, "fault_values" },
    { PROP_FEEDBACK_VALUE, "feedback_value" },
    { PROP_FILE_ACCESS_METHOD, "file_access_method" },
    { PROP_FILE_SIZE, "file_size" },
    { PROP_FILE_TYPE, "file_type" },
    { PROP_FIRMWARE_REVISION,
      "firmware_revision" }, /* VTS wants "revision", not "version" */
    { PROP_HIGH_LIMIT, "high_limit" },
    { PROP_INACTIVE_TEXT, "inactive_text" },
    { PROP_IN_PROCESS, "in_process" },
    { PROP_INSTANCE_OF, "instance_of" },
    { PROP_INTEGRAL_CONSTANT, "integral_constant" },
    { PROP_INTEGRAL_CONSTANT_UNITS, "integral_constant_units" },
    { PROP_ISSUE_CONFIRMED_NOTIFICATIONS, "issue_confirmednotifications" },
    { PROP_LIMIT_ENABLE, "limit_enable" },
    { PROP_LIST_OF_GROUP_MEMBERS, "list_of_group_members" },
    { PROP_LIST_OF_OBJECT_PROPERTY_REFERENCES,
      "list_of_object_property_references" },
    { PROP_LIST_OF_SESSION_KEYS, "list_of_session_keys" },
    { PROP_LOCAL_DATE, "local_date" },
    { PROP_LOCAL_TIME, "local_time" },
    { PROP_LOCATION, "location" },
    { PROP_LOW_LIMIT, "low_limit" },
    { PROP_MANIPULATED_VARIABLE_REFERENCE, "manipulated_variable_reference" },
    { PROP_MAXIMUM_OUTPUT, "maximum_output" },
    { PROP_MAX_APDU_LENGTH_ACCEPTED, "max_apdu_length_accepted" },
    { PROP_MAX_INFO_FRAMES, "max_info_frames" },
    { PROP_MAX_MASTER, "max_master" },
    { PROP_MAX_PRES_VALUE, "max_pres_value" },
    { PROP_MINIMUM_OFF_TIME, "minimum_off_time" },
    { PROP_MINIMUM_ON_TIME, "minimum_on_time" },
    { PROP_MINIMUM_OUTPUT, "minimum_output" },
    { PROP_MIN_PRES_VALUE, "min_pres_value" },
    { PROP_MODEL_NAME, "model_name" },
    { PROP_MODIFICATION_DATE, "modification_date" },
    { PROP_NOTIFY_TYPE, "notify_type" },
    { PROP_NUMBER_OF_APDU_RETRIES, "number_of_APDU_retries" },
    { PROP_NUMBER_OF_STATES, "number_of_states" },
    { PROP_OBJECT_IDENTIFIER, "object_identifier" },
    { PROP_OBJECT_LIST, "object_list" },
    { PROP_OBJECT_NAME, "object_name" },
    { PROP_OBJECT_PROPERTY_REFERENCE, "object_property_reference" },
    { PROP_OBJECT_TYPE, "object_type" },
    { PROP_OPTIONAL, "optional" },
    { PROP_OUT_OF_SERVICE, "out_of_service" },
    { PROP_OUTPUT_UNITS, "output_units" },
    { PROP_EVENT_PARAMETERS, "event_parameters" },
    { PROP_POLARITY, "polarity" },
    { PROP_PRESENT_VALUE, "present_value" },
    { PROP_PRIORITY, "priority" },
    { PROP_PRIORITY_ARRAY, "priority_array" },
    { PROP_PRIORITY_FOR_WRITING, "priority_for_writing" },
    { PROP_PROCESS_IDENTIFIER, "process_identifier" },
    { PROP_PROGRAM_CHANGE, "program_change" },
    { PROP_PROGRAM_LOCATION, "program_location" },
    { PROP_PROGRAM_STATE, "program_state" },
    { PROP_PROPORTIONAL_CONSTANT, "proportional_constant" },
    { PROP_PROPORTIONAL_CONSTANT_UNITS, "proportional_constant_units" },
    { PROP_PROTOCOL_CONFORMANCE_CLASS, "protocol_conformance_class" },
    { PROP_PROTOCOL_OBJECT_TYPES_SUPPORTED, "protocol_object_types_supported" },
    { PROP_PROTOCOL_SERVICES_SUPPORTED, "protocol_services_supported" },
    { PROP_PROTOCOL_VERSION, "protocol_version" },
    { PROP_READ_ONLY, "read_only" },
    { PROP_REASON_FOR_HALT, "reason_for_halt" },
    { PROP_RECIPIENT, "recipient" },
    { PROP_RECIPIENT_LIST, "recipient_list" },
    { PROP_RELIABILITY, "reliability" },
    { PROP_RELINQUISH_DEFAULT, "relinquish_default" },
    { PROP_REQUIRED, "required" },
    { PROP_RESOLUTION, "resolution" },
    { PROP_SEGMENTATION_SUPPORTED, "segmentation_supported" },
    { PROP_SETPOINT, "setpoint" },
    { PROP_SETPOINT_REFERENCE, "setpoint_reference" },
    { PROP_STATE_TEXT, "state_text" },
    { PROP_STATUS_FLAGS, "status_flags" },
    { PROP_SYSTEM_STATUS, "system_status" },
    { PROP_TIME_DELAY, "time_delay" },
    { PROP_TIME_OF_ACTIVE_TIME_RESET, "time_of_active_time_reset" },
    { PROP_TIME_OF_STATE_COUNT_RESET, "time_of_state_count_reset" },
    { PROP_TIME_SYNCHRONIZATION_RECIPIENTS, "time_synchronization_recipients" },
    { PROP_UNITS, "units" },
    { PROP_UPDATE_INTERVAL, "update_interval" },
    { PROP_UTC_OFFSET, "utc_offset" },
    { PROP_VENDOR_IDENTIFIER, "vendor_identifier" },
    { PROP_VENDOR_NAME, "vendor_name" },
    { PROP_VT_CLASSES_SUPPORTED, "vt_classes_supported" },
    { PROP_WEEKLY_SCHEDULE, "weekly_schedule" },
    { PROP_ATTEMPTED_SAMPLES, "attempted_samples" },
    { PROP_AVERAGE_VALUE, "average_value" },
    { PROP_BUFFER_SIZE, "buffer_size" },
    { PROP_CLIENT_COV_INCREMENT, "client_cov_increment" },
    { PROP_COV_RESUBSCRIPTION_INTERVAL, "cov_resubscription_interval" },
    { PROP_CURRENT_NOTIFY_TIME, "current_notify_time" },
    { PROP_EVENT_TIME_STAMPS, "event_time_stamps" },
    { PROP_LOG_BUFFER, "log_buffer" },
    { PROP_LOG_DEVICE_OBJECT_PROPERTY, "log_device_object_property" },
    { PROP_ENABLE, "enable" },
    { PROP_LOG_INTERVAL, "log_interval" },
    { PROP_MAXIMUM_VALUE, "maximum_value" },
    { PROP_MINIMUM_VALUE, "minimum_value" },
    { PROP_NOTIFICATION_THRESHOLD, "notification_threshold" },
    { PROP_PREVIOUS_NOTIFY_TIME, "previous_notify_time" },
    { PROP_PROTOCOL_REVISION, "protocol_revision" },
    { PROP_RECORDS_SINCE_NOTIFICATION, "records_since_notification" },
    { PROP_RECORD_COUNT, "record_count" },
    { PROP_START_TIME, "start_time" },
    { PROP_STOP_TIME, "stop_time" },
    { PROP_STOP_WHEN_FULL, "stop_when_full" },
    { PROP_TOTAL_RECORD_COUNT, "total_record_count" },
    { PROP_VALID_SAMPLES, "valid_samples" },
    { PROP_WINDOW_INTERVAL, "window_interval" },
    { PROP_WINDOW_SAMPLES, "window_samples" },
    { PROP_MAXIMUM_VALUE_TIMESTAMP, "maximum_value_timestamp" },
    { PROP_MINIMUM_VALUE_TIMESTAMP, "minimum_value_timestamp" },
    { PROP_VARIANCE_VALUE, "variance_value" },
    { PROP_ACTIVE_COV_SUBSCRIPTIONS, "active_cov_subscriptions" },
    { PROP_BACKUP_FAILURE_TIMEOUT, "backup_failure_timeout" },
    { PROP_CONFIGURATION_FILES, "configuration_files" },
    { PROP_DATABASE_REVISION, "database_revision" },
    { PROP_DIRECT_READING, "direct_reading" },
    { PROP_LAST_RESTORE_TIME, "last_restore_time" },
    { PROP_MAINTENANCE_REQUIRED, "maintenance_required" },
    { PROP_MEMBER_OF, "member_of" },
    { PROP_MODE, "mode" },
    { PROP_OPERATION_EXPECTED, "operation_expected" },
    { PROP_SETTING, "setting" },
    { PROP_SILENCED, "silenced" },
    { PROP_TRACKING_VALUE, "tracking_value" },
    { PROP_ZONE_MEMBERS, "zone_members" },
    { PROP_LIFE_SAFETY_ALARM_VALUES, "life_safety_alarm_values" },
    { PROP_MAX_SEGMENTS_ACCEPTED, "max_segments_accepted" },
    { PROP_PROFILE_NAME, "profile_name" },
    { PROP_AUTO_SLAVE_DISCOVERY, "auto_slave_discovery" },
    { PROP_MANUAL_SLAVE_ADDRESS_BINDING, "manual_slave_address_binding" },
    { PROP_SLAVE_ADDRESS_BINDING, "slave_address_binding" },
    { PROP_SLAVE_PROXY_ENABLE, "slave_proxy_enable" },
    { PROP_LAST_NOTIFY_RECORD, "last_notify_record" },
    { PROP_SCHEDULE_DEFAULT, "schedule_default" },
    { PROP_ACCEPTED_MODES, "accepted_modes" },
    { PROP_ADJUST_VALUE, "adjust_value" },
    { PROP_COUNT, "count" },
    { PROP_COUNT_BEFORE_CHANGE, "count_before_change" },
    { PROP_COUNT_CHANGE_TIME, "count_change_time" },
    { PROP_COV_PERIOD, "COV_period" },
    { PROP_INPUT_REFERENCE, "input_reference" },
    { PROP_LIMIT_MONITORING_INTERVAL, "limit_monitoring_interval" },
    { PROP_LOGGING_OBJECT, "logging_object" },
    { PROP_LOGGING_RECORD, "logging_record" },
    { PROP_PRESCALE, "prescale" },
    { PROP_PULSE_RATE, "pulse_rate" },
    { PROP_SCALE, "scale" },
    { PROP_SCALE_FACTOR, "scale_factor" },
    { PROP_UPDATE_TIME, "update_time" },
    { PROP_VALUE_BEFORE_CHANGE, "value_before_change" },
    { PROP_VALUE_SET, "value_set" },
    { PROP_VALUE_CHANGE_TIME, "value_change_time" },
    { PROP_ALIGN_INTERVALS, "align_intervals" },
    { PROP_INTERVAL_OFFSET, "interval_offset" },
    { PROP_LAST_RESTART_REASON, "last_restart_reason" },
    { PROP_LOGGING_TYPE, "logging_type" },
    { PROP_RESTART_NOTIFICATION_RECIPIENTS, "restart_notification_recipients" },
    { PROP_TIME_OF_DEVICE_RESTART, "time_of_device_restart" },
    { PROP_TIME_SYNCHRONIZATION_INTERVAL, "time_synchronization_interval" },
    { PROP_TRIGGER, "trigger" },
    { PROP_UTC_TIME_SYNCHRONIZATION_RECIPIENTS,
      "utc_time_synchronization_recipients" },
    { PROP_NODE_SUBTYPE, "node_subtype" },
    { PROP_NODE_TYPE, "node_type" },
    { PROP_STRUCTURED_OBJECT_LIST, "structured_object_list" },
    { PROP_SUBORDINATE_ANNOTATIONS, "subordinate_annotations" },
    { PROP_SUBORDINATE_LIST, "subordinate_list" },
    { PROP_ACTUAL_SHED_LEVEL, "actual_shed_level" },
    { PROP_DUTY_WINDOW, "duty_window" },
    { PROP_EXPECTED_SHED_LEVEL, "expected_shed_level" },
    { PROP_FULL_DUTY_BASELINE, "full_duty_baseline" },
    { PROP_REQUESTED_SHED_LEVEL, "requested_shed_level" },
    { PROP_SHED_DURATION, "shed_duration" },
    { PROP_SHED_LEVEL_DESCRIPTIONS, "shed_level_descriptions" },
    { PROP_SHED_LEVELS, "shed_levels" },
    { PROP_STATE_DESCRIPTION, "state_description" },
    { PROP_DOOR_ALARM_STATE, "door_alarm_state" },
    { PROP_DOOR_EXTENDED_PULSE_TIME, "door_extended_pulse_time" },
    { PROP_DOOR_MEMBERS, "door_members" },
    { PROP_DOOR_OPEN_TOO_LONG_TIME, "door_open_too_long_time" },
    { PROP_DOOR_PULSE_TIME, "door_pulse_time" },
    { PROP_DOOR_STATUS, "door_status" },
    { PROP_DOOR_UNLOCK_DELAY_TIME, "door_unlock_delay_time" },
    { PROP_LOCK_STATUS, "lock_status" },
    { PROP_MASKED_ALARM_VALUES, "masked_alarm_values" },
    { PROP_SECURED_STATUS, "secured_status" },
    { PROP_ABSENTEE_LIMIT, "absentee_limit" },
    { PROP_ACCESS_ALARM_EVENTS, "access_alarm_events" },
    { PROP_ACCESS_DOORS, "access_doors" },
    { PROP_ACCESS_EVENT, "access_event" },
    { PROP_ACCESS_EVENT_AUTHENTICATION_FACTOR,
      "access_event_authentication_factor" },
    { PROP_ACCESS_EVENT_CREDENTIAL, "access_event_credential" },
    { PROP_ACCESS_EVENT_TIME, "access_event_time" },
    { PROP_ACCESS_TRANSACTION_EVENTS, "access_transaction_events" },
    { PROP_ACCOMPANIMENT, "accompaniment" },
    { PROP_ACCOMPANIMENT_TIME, "accompaniment_time" },
    { PROP_ACTIVATION_TIME, "activation_time" },
    { PROP_ACTIVE_AUTHENTICATION_POLICY, "active_authentication_policy" },
    { PROP_ASSIGNED_ACCESS_RIGHTS, "assigned_access_rights" },
    { PROP_AUTHENTICATION_FACTORS, "authentication_factors" },
    { PROP_AUTHENTICATION_POLICY_LIST, "authentication_policy_list" },
    { PROP_AUTHENTICATION_POLICY_NAMES, "authentication_policy_names" },
    { PROP_AUTHENTICATION_STATUS, "authentication_status" },
    { PROP_AUTHORIZATION_MODE, "authorization_mode" },
    { PROP_BELONGS_TO, "belongs_to" },
    { PROP_CREDENTIAL_DISABLE, "credential_disable" },
    { PROP_CREDENTIAL_STATUS, "credential_status" },
    { PROP_CREDENTIALS, "credentials" },
    { PROP_CREDENTIALS_IN_ZONE, "credentials_in_zone" },
    { PROP_DAYS_REMAINING, "days_remaining" },
    { PROP_ENTRY_POINTS, "entry_points" },
    { PROP_EXIT_POINTS, "exit_points" },
    { PROP_EXPIRATION_TIME, "expiration_time" },
    { PROP_EXTENDED_TIME_ENABLE, "extended_time_enable" },
    { PROP_FAILED_ATTEMPT_EVENTS, "failed_attempt_events" },
    { PROP_FAILED_ATTEMPTS, "failed_attempts" },
    { PROP_FAILED_ATTEMPTS_TIME, "failed_attempts_time" },
    { PROP_LAST_ACCESS_EVENT, "last_access_event" },
    { PROP_LAST_ACCESS_POINT, "last_access_point" },
    { PROP_LAST_CREDENTIAL_ADDED, "last_credential_added" },
    { PROP_LAST_CREDENTIAL_ADDED_TIME, "last_credential_added_time" },
    { PROP_LAST_CREDENTIAL_REMOVED, "last_credential_removed" },
    { PROP_LAST_CREDENTIAL_REMOVED_TIME, "last_credential_removed_time" },
    { PROP_LAST_USE_TIME, "last_use_time" },
    { PROP_LOCKOUT, "lockout" },
    { PROP_LOCKOUT_RELINQUISH_TIME, "lockout_relinquish_time" },
    { PROP_MASTER_EXEMPTION, "master_exemption" },
    { PROP_MAX_FAILED_ATTEMPTS, "max_failed_attempts" },
    { PROP_MEMBERS, "members" },
    { PROP_MUSTER_POINT, "muster_point" },
    { PROP_NEGATIVE_ACCESS_RULES, "negative_access_rules" },
    { PROP_NUMBER_OF_AUTHENTICATION_POLICIES,
      "number_of_authentication_policies" },
    { PROP_OCCUPANCY_COUNT, "occupancy_count" },
    { PROP_OCCUPANCY_COUNT_ADJUST, "occupancy_count_adjust" },
    { PROP_OCCUPANCY_COUNT_ENABLE, "occupancy_count_enable" },
    { PROP_OCCUPANCY_EXEMPTION, "occupancy_exemption" },
    { PROP_OCCUPANCY_LOWER_LIMIT, "occupancy_lower_limit" },
    { PROP_OCCUPANCY_LOWER_LIMIT_ENFORCED, "occupancy_lower_limit_enforced" },
    { PROP_OCCUPANCY_STATE, "occupancy_state" },
    { PROP_OCCUPANCY_UPPER_LIMIT, "occupancy_upper_limit" },
    { PROP_OCCUPANCY_UPPER_LIMIT_ENFORCED, "occupancy_upper_limit_enforced" },
    { PROP_PASSBACK_EXEMPTION, "passback_exemption" },
    { PROP_PASSBACK_MODE, "passback_mode" },
    { PROP_PASSBACK_TIMEOUT, "passback_timeout" },
    { PROP_POSITIVE_ACCESS_RULES, "positive_access_rules" },
    { PROP_REASON_FOR_DISABLE, "reason_for_disable" },
    { PROP_SUPPORTED_FORMATS, "supported_formats" },
    { PROP_SUPPORTED_FORMAT_CLASSES, "supported_format_classes" },
    { PROP_THREAT_AUTHORITY, "threat_authority" },
    { PROP_THREAT_LEVEL, "threat_level" },
    { PROP_TRACE_FLAG, "trace_flag" },
    { PROP_TRANSACTION_NOTIFICATION_CLASS, "transaction_notification_class" },
    { PROP_USER_EXTERNAL_IDENTIFIER, "user_external_identifier" },
    { PROP_USER_INFORMATION_REFERENCE, "user_information_reference" },
    { PROP_USER_INFORMATION_REFERENCE, "user_information_reference" },
    { PROP_USER_NAME, "user_name" },
    { PROP_USER_TYPE, "user_type" },
    { PROP_USES_REMAINING, "uses_remaining" },
    { PROP_ZONE_FROM, "zone_from" },
    { PROP_ZONE_TO, "zone_to" },
    { PROP_VERIFICATION_TIME, "verification_time" },
    { PROP_BASE_DEVICE_SECURITY_POLICY, "base_device_security_policy" },
    { PROP_DISTRIBUTION_KEY_REVISION, "distribution_key_revision" },
    { PROP_DO_NOT_HIDE, "do_not_hide" },
    { PROP_KEY_SETS, "key_sets" },
    { PROP_LAST_KEY_SERVER, "last_key_server" },
    { PROP_NETWORK_ACCESS_SECURITY_POLICIES,
      "network_access_security_policies" },
    { PROP_PACKET_REORDER_TIME, "packet_reorder_time" },
    { PROP_SECURITY_PDU_TIMEOUT, "security_pdu_timeout" },
    { PROP_SECURITY_TIME_WINDOW, "security_time_window" },
    { PROP_SUPPORTED_SECURITY_ALGORITHM, "supported_security_algorithm" },
    { PROP_UPDATE_KEY_SET_TIMEOUT, "update_key_set_timeout" },
    { PROP_BACKUP_AND_RESTORE_STATE, "backup_and_restore_state" },
    { PROP_BACKUP_PREPARATION_TIME, "backup_preparation_time" },
    { PROP_RESTORE_COMPLETION_TIME, "restore_completion_time" },
    { PROP_RESTORE_PREPARATION_TIME, "restore_preparation_time" },
    { PROP_BIT_MASK, "bit_mask" },
    { PROP_BIT_TEXT, "bit_text" },
    { PROP_IS_UTC, "is_utc" },
    { PROP_GROUP_MEMBERS, "group_members" },
    { PROP_GROUP_MEMBER_NAMES, "group_member_names" },
    { PROP_MEMBER_STATUS_FLAGS, "member_status_flags" },
    { PROP_REQUESTED_UPDATE_INTERVAL, "requested_update_interval" },
    { PROP_COVU_PERIOD, "covu_period" },
    { PROP_COVU_RECIPIENTS, "covu_recipients" },
    { PROP_EVENT_MESSAGE_TEXTS, "event_message_texts" },
    { PROP_EVENT_MESSAGE_TEXTS_CONFIG, "event_message_texts_config" },
    { PROP_EVENT_DETECTION_ENABLE, "event_detection_enable" },
    { PROP_EVENT_ALGORITHM_INHIBIT, "event_algorithm_inhibit" },
    { PROP_EVENT_ALGORITHM_INHIBIT_REF, "event_algorithm_inhibit_ref" },
    { PROP_TIME_DELAY_NORMAL, "time_delay_normal" },
    { PROP_RELIABILITY_EVALUATION_INHIBIT, "reliability_evaluation_inhibit" },
    { PROP_FAULT_PARAMETERS, "fault_parameters" },
    { PROP_FAULT_TYPE, "fault_type" },
    { PROP_LOCAL_FORWARDING_ONLY, "local_forwarding_only" },
    { PROP_PROCESS_IDENTIFIER_FILTER, "process_identifier_filter" },
    { PROP_SUBSCRIBED_RECIPIENTS, "subscribed_recipients" },
    { PROP_PORT_FILTER, "port_filter" },
    { PROP_AUTHORIZATION_EXEMPTIONS, "authorization_exemptions" },
    { PROP_ALLOW_GROUP_DELAY_INHIBIT, "allow_group_delay_inhibit" },
    { PROP_CHANNEL_NUMBER, "channel_number" },
    { PROP_CONTROL_GROUPS, "control_groups" },
    { PROP_EXECUTION_DELAY, "execution_delay" },
    { PROP_LAST_PRIORITY, "last_priority" },
    { PROP_WRITE_STATUS, "write_status" },
    { PROP_PROPERTY_LIST, "property_list" },
    { PROP_SERIAL_NUMBER, "serial_number" },
    { PROP_BLINK_WARN_ENABLE, "blink_warn_enable" },
    { PROP_DEFAULT_FADE_TIME, "default_fade_time" },
    { PROP_DEFAULT_RAMP_RATE, "default_ramp_rate" },
    { PROP_DEFAULT_STEP_INCREMENT, "default_step_increment" },
    { PROP_EGRESS_TIME, "egress_time" },
    { PROP_IN_PROGRESS, "in_progress" },
    { PROP_INSTANTANEOUS_POWER, "instantaneous_power" },
    { PROP_LIGHTING_COMMAND, "lighting_command" },
    { PROP_LIGHTING_COMMAND_DEFAULT_PRIORITY,
      "lighting_command_default_priority" },
    { PROP_MAX_ACTUAL_VALUE, "max_actual_value" },
    { PROP_MIN_ACTUAL_VALUE, "min_actual_value" },
    { PROP_POWER, "power" },
    { PROP_TRANSITION, "transition" },
    { PROP_EGRESS_ACTIVE, "egress_active" },
    { PROP_INTERFACE_VALUE, "inteface_value" },
    { PROP_FAULT_HIGH_LIMIT, "fault_high_limit" },
    { PROP_FAULT_LOW_LIMIT, "fault_low_limit" },
    { PROP_LOW_DIFF_LIMIT, "low_diff_limit" },
    { PROP_STRIKE_COUNT, "strike_count" },
    { PROP_TIME_OF_STRIKE_COUNT_RESET, "strike_count" },
    { PROP_DEFAULT_TIMEOUT, "default_timeout" },
    { PROP_INITIAL_TIMEOUT, "initial_timeout" },
    { PROP_LAST_STATE_CHANGE, "last_state_change" },
    { PROP_STATE_CHANGE_VALUES, "state_change_values" },
    { PROP_TIMER_RUNNING, "timer_running" },
    { PROP_TIMER_STATE, "timer_state" },
    { PROP_APDU_LENGTH, "apdu_length" },
    { PROP_IP_ADDRESS, "ip_address" },
    { PROP_IP_DEFAULT_GATEWAY, "ip_default_gateway" },
    { PROP_IP_DHCP_ENABLE, "ip_dhcp_enable" },
    { PROP_IP_DHCP_LEASE_TIME, "ip_dhcp_lease_time" },
    { PROP_IP_DHCP_LEASE_TIME_REMAINING, "ip_dhcp_lease_time_remaining" },
    { PROP_IP_DHCP_SERVER, "ip_dhcp_server" },
    { PROP_IP_DNS_SERVER, "ip_dns_server" },
    { PROP_BACNET_IP_GLOBAL_ADDRESS, "bacnet_ip_global_address" },
    { PROP_BACNET_IP_MODE, "bacnet_ip_mode" },
    { PROP_BACNET_IP_MULTICAST_ADDRESS, "bacnet_ip_multicast_address" },
    { PROP_BACNET_IP_NAT_TRAVERSAL, "bacnet_ip_nat_traversal" },
    { PROP_IP_SUBNET_MASK, "ip_subnet_mask" },
    { PROP_BACNET_IP_UDP_PORT, "bacnet_ip_udp_port" },
    { PROP_BBMD_ACCEPT_FD_REGISTRATIONS, "bbmd_accept_fd_registrations" },
    { PROP_BBMD_BROADCAST_DISTRIBUTION_TABLE,
      "bbmd_broadcast_distribution_table" },
    { PROP_BBMD_FOREIGN_DEVICE_TABLE, "bbmd_foreign_device_table" },
    { PROP_CHANGES_PENDING, "changes_pending" },
    { PROP_COMMAND, "command" },
    { PROP_FD_BBMD_ADDRESS, "fd_bbmd_address" },
    { PROP_FD_SUBSCRIPTION_LIFETIME, "fd_subscription_lifetime" },
    { PROP_LINK_SPEED, "link_speed" },
    { PROP_LINK_SPEEDS, "link_speeds" },
    { PROP_LINK_SPEED_AUTONEGOTIATE, "link_speed_autonegotiate" },
    { PROP_MAC_ADDRESS, "mac_address" },
    { PROP_NETWORK_INTERFACE_NAME, "network_interface_name" },
    { PROP_NETWORK_NUMBER, "network_number" },
    { PROP_NETWORK_NUMBER_QUALITY, "network_number_quality" },
    { PROP_NETWORK_TYPE, "network_type" },
    { PROP_ROUTING_TABLE, "routing_table" },
    { PROP_VIRTUAL_MAC_ADDRESS_TABLE, "virtual_mac_address_table" },
    { PROP_COMMAND_TIME_ARRAY, "command_time_array" },
    { PROP_CURRENT_COMMAND_PRIORITY, "current_command_priority" },
    { PROP_LAST_COMMAND_TIME, "last_command_time" },
    { PROP_VALUE_SOURCE, "value_source" },
    { PROP_VALUE_SOURCE_ARRAY, "value_source_array" },
    { PROP_BACNET_IPV6_MODE, "bacnet_ipv6_mode" },
    { PROP_IPV6_ADDRESS, "ipv6_address" },
    { PROP_IPV6_PREFIX_LENGTH, "ipv6_prefix_length" },
    { PROP_BACNET_IPV6_UDP_PORT, "bacnet_ipv6_udp_port" },
    { PROP_IPV6_DEFAULT_GATEWAY, "ipv6_default_gateway" },
    { PROP_BACNET_IPV6_MULTICAST_ADDRESS, "bacnet_ipv6_multicast_address" },
    { PROP_IPV6_DNS_SERVER, "ipv6_dns_server" },
    { PROP_IPV6_AUTO_ADDRESSING_ENABLE, "ipv6_auto_addressing_enable" },
    { PROP_IPV6_DHCP_LEASE_TIME, "ipv6_dhcp_lease_time" },
    { PROP_IPV6_DHCP_LEASE_TIME_REMAINING, "ipv6_dhcp_lease_time_remaining" },
    { PROP_IPV6_DHCP_SERVER, "ipv6_dhcp_server" },
    { PROP_IPV6_ZONE_INDEX, "ipv6_zone_index" },
    { PROP_ASSIGNED_LANDING_CALLS, "assigned_landing_calls" },
    { PROP_CAR_ASSIGNED_DIRECTION, "car_assigned_direction" },
    { PROP_CAR_DOOR_COMMAND, "car_door_command" },
    { PROP_CAR_DOOR_STATUS, "car_door_status" },
    { PROP_CAR_DOOR_TEXT, "car_door_text" },
    { PROP_CAR_DOOR_ZONE, "car_door_zone" },
    { PROP_CAR_DRIVE_STATUS, "car_drive_status" },
    { PROP_CAR_LOAD, "car_load" },
    { PROP_CAR_LOAD_UNITS, "car_load_units" },
    { PROP_CAR_MODE, "car_mode" },
    { PROP_CAR_MOVING_DIRECTION, "car_moving_direction" },
    { PROP_CAR_POSITION, "car_position" },
    { PROP_ELEVATOR_GROUP, "elevator_group" },
    { PROP_ENERGY_METER, "energy_meter" },
    { PROP_ENERGY_METER_REF, "energy_meter_ref" },
    { PROP_ESCALATOR_MODE, "escalator_mode" },
    { PROP_FAULT_SIGNALS, "fault_signals" },
    { PROP_FLOOR_TEXT, "floor_text" },
    { PROP_GROUP_ID, "group_id" },
    { PROP_GROUP_MODE, "group_mode" },
    { PROP_HIGHER_DECK, "higher_deck" },
    { PROP_INSTALLATION_ID, "installation_id" },
    { PROP_LANDING_CALLS, "landing_calls" },
    { PROP_LANDING_CALL_CONTROL, "landing_call_control" },
    { PROP_LANDING_DOOR_STATUS, "landing_door_status" },
    { PROP_LOWER_DECK, "lower_deck" },
    { PROP_MACHINE_ROOM_ID, "machine_room_id" },
    { PROP_MAKING_CAR_CALL, "making_car_call" },
    { PROP_NEXT_STOPPING_FLOOR, "next_stopping_floor" },
    { PROP_OPERATION_DIRECTION, "operation_direction" },
    { PROP_PASSENGER_ALARM, "passenger_alarm" },
    { PROP_POWER_MODE, "power_mode" },
    { PROP_REGISTERED_CAR_CALL, "registered_car_call" },
    { PROP_ACTIVE_COV_MULTIPLE_SUBSCRIPTIONS,
      "active_cov_multiple_subscriptions" },
    { PROP_PROTOCOL_LEVEL, "protocol_level" },
    { PROP_REFERENCE_PORT, "reference_port" },
    { PROP_DEPLOYED_PROFILE_LOCATION, "deployed_profile_location" },
    { PROP_PROFILE_LOCATION, "profile_location" },
    { PROP_TAGS, "tags" },
    { PROP_SUBORDINATE_NODE_TYPES, "subordinate_node_types" },
    { PROP_SUBORDINATE_TAGS, "subordinate_tags" },
    { PROP_SUBORDINATE_RELATIONSHIPS, "subordinate_relationships" },
    { PROP_DEFAULT_SUBORDINATE_RELATIONSHIP,
      "default_subordinate_relationship" },
    { PROP_REPRESENTS, "represents" },
    { PROP_DEFAULT_PRESENT_VALUE, "default_present_value" },
    { PROP_PRESENT_STAGE, "present_stage" },
    { PROP_STAGES, "stages" },
    { PROP_STAGE_NAMES, "stage_names" },
    { PROP_TARGET_REFERENCES, "target_references" },
    { PROP_AUDIT_SOURCE_LEVEL, "audit_source_level" },
    { PROP_AUDIT_LEVEL, "audit_level" },
    { PROP_AUDIT_NOTIFICATION_RECIPIENT, "audit_notification_recipient" },
    { PROP_AUDIT_PRIORITY_FILTER, "audit_priority_filter" },
    { PROP_AUDITABLE_OPERATIONS, "auditable_operations" },
    { PROP_DELETE_ON_FORWARD, "delete_on_forward" },
    { PROP_MAXIMUM_SEND_DELAY, "maximum_send_delay" },
    { PROP_MONITORED_OBJECTS, "monitored_objects" },
    { PROP_SEND_NOW, "send_now" },
    { PROP_FLOOR_NUMBER, "floor_number" },
    { PROP_DEVICE_UUID, "device_uuid" },
    { PROP_ADDITIONAL_REFERENCE_PORTS, "additional_reference_ports" },
    { PROP_CERTIFICATE_SIGNING_REQUEST_FILE,
      "certificate_signing_request_file" },
    { PROP_COMMAND_VALIDATION_RESULT, "command_validation_result" },
    { PROP_ISSUER_CERTIFICATE_FILES, "issuer_certificate_files" },
    { PROP_MAX_BVLC_LENGTH_ACCEPTED, "max_bvlc_length_accepted" },
    { PROP_MAX_NPDU_LENGTH_ACCEPTED, "max_npdu_length_accepted" },
    { PROP_OPERATIONAL_CERTIFICATE_FILE, "operational_certificate_file" },
    { PROP_CURRENT_HEALTH, "current_health" },
    { PROP_SC_CONNECT_WAIT_TIMEOUT, "sc_connect_wait_timeout" },
    { PROP_SC_DIRECT_CONNECT_ACCEPT_ENABLE, "sc_direct_connect_accept_enable" },
    { PROP_SC_DIRECT_CONNECT_ACCEPT_URIS, "sc_direct_connect_accept_uris" },
    { PROP_SC_DIRECT_CONNECT_BINDING, "sc_direct_connect_binding" },
    ...
    { PROP_SC_DISCONNECT_WAIT_TIMEOUT, "sc_disconnect_wait_timeout" },
    { PROP_SC_FAILED_CONNECTION_REQUESTS, "sc_failed_connection_requests" },
    { PROP_SC_FAILOVER_HUB_CONNECTION_STATUS,
      "sc_failover_hub_connection_status" },
    { PROP_SC_FAILOVER_HUB_URI, "sc_failover_hub_uri" },
    { PROP_SC_HUB_CONNECTOR_STATE, "sc_hub_connector_state" },
    { PROP_SC_HUB_FUNCTION_ACCEPT_URIS, "sc_hub_function_accept_uris" },
    { PROP_SC_HUB_FUNCTION_BINDING, "sc_hub_function_binding" },
    { PROP_SC_HUB_FUNCTION_CONNECTION_STATUS,
      "sc_hub_function_connection_status" },
    { PROP_SC_HUB_FUNCTION_ENABLE, "sc_hub_function_enable" },
    { PROP_SC_HEARTBEAT_TIMEOUT, "sc_heartbeat_timeout" },
    { PROP_SC_PRIMARY_HUB_CONNECTION_STATUS,
      "sc_primary_hub_connection_status" },
    { PROP_SC_PRIMARY_HUB_URI, "sc_primary_hub_uri" },
    { PROP_SC_MAXIMUM_RECONNECT_TIME, "sc_maximum_reconnect_time" },
    { PROP_SC_MINIMUM_RECONNECT_TIME, "sc_minimum_reconnect_time" },
    { PROP_COLOR_OVERRIDE, "color_override" },
    { PROP_COLOR_REFERENCE, "color_reference" },
    { PROP_DEFAULT_COLOR, "default_color" },
    { PROP_DEFAULT_COLOR_TEMPERATURE, "default_color_temperature" },
    { PROP_OVERRIDE_COLOR_REFERENCE, "override_color_reference" },
    { PROP_COLOR_COMMAND, "color_command" },
    { PROP_HIGH_END_TRIM, "high_end_trim" },
    { PROP_LOW_END_TRIM, "low_end_trim" },
    { PROP_TRIM_FADE_TIME, "trim_fade_time" },
    { PROP_DEVICE_ADDRESS_PROXY_ENABLE, "device_address_proxy_enable" },
    { PROP_DEVICE_ADDRESS_PROXY_TABLE, "device_address_proxy_table" },
    { PROP_DEVICE_ADDRESS_PROXY_TIMEOUT, "device_address_proxy_timeout" },
    { PROP_DEFAULT_ON_VALUE, "default_on_value" },
    { PROP_LAST_ON_VALUE, "last_on_value" },
    { PROP_AUTHORIZATION_CACHE, "authorization_cache" },
    { PROP_AUTHORIZATION_GROUPS, "authorization_groups" },
    { PROP_AUTHORIZATION_POLICY, "authorization_policy" },
    { PROP_AUTHORIZATION_SCOPE, "authorization_scope" },
    { PROP_AUTHORIZATION_SERVER, "authorization_server" },
    { PROP_AUTHORIZATION_STATUS, "authorization_status" },
    { PROP_MAX_PROXIED_I_AMS_PER_SECOND, "max_proxied_i_ams_per_second" },
    { 0, NULL }
};
