...
/**
* Multistate_Value_Object() replaced by
* Keylist_Data(Object_List, object_instance)
*
* Multistate_Value_Object_Index() replaced by
* Keylist_Data(Object_List, Multistate_Value_Index_To_Instance(index)
*
*/
	...
	struct itr_ctx *ictx)
{
    ...
    pObject->Object_Name = ucix_get_option_char(ictx->ctx, ictx->section, sec_idx,
        "name");
    if (!pObject->Object_Name) {
        snprintf(options, sizeof(options), "Multistate Value %i", idx);
    ...
    BACNET_GET_EVENT_INFORMATION_DATA * getevent_data)
{
    ...
    instance = Multistate_Value_Index_To_Instance(index);
