...
BACNET_STACK_EXPORT
bool Binary_Input_Event_State_Set(uint32_t object_instance, unsigned state);

BACNET_STACK_EXPORT
bool Binary_Input_Present_Value_Relinquish(uint32_t instance, unsigned priority);

BACNET_STACK_EXPORT
unsigned Binary_Input_Present_Value_Priority(uint32_t object_instance);

BACNET_STACK_EXPORT
BACNET_BINARY_PV Binary_Input_Relinquish_Default(uint32_t object_instance);

BACNET_STACK_EXPORT
bool Binary_Input_Relinquish_Default_Set(uint32_t object_instance, BACNET_BINARY_PV value);

BACNET_STACK_EXPORT
bool Binary_Input_Overridden(uint32_t instance);

BACNET_STACK_EXPORT
void Binary_Input_Overridden_Set(uint32_t instance, bool oos_flag);
