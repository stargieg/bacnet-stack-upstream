...
BACNET_STACK_EXPORT
bool Analog_Value_Object_Instance_Add(uint32_t instance);
BACNET_STACK_EXPORT
bool Analog_Value_Present_Value_Relinquish(uint32_t object_instance, unsigned priority);
BACNET_STACK_EXPORT
...
BACNET_STACK_EXPORT
bool Analog_Value_Overridden(uint32_t instance);
BACNET_STACK_EXPORT
void Analog_Value_Overridden_Set(uint32_t instance, bool oos_flag);
BACNET_STACK_EXPORT
