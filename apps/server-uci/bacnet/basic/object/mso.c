...
/**
* Multistate_Output_Object() replaced by
* Keylist_Data(Object_List, object_instance)
*
* Multistate_Output_Object_Index() replaced by
* Keylist_Data(Object_List, Multistate_Output_Index_To_Instance(index)
*
*/
 ...
 */
static struct object_data *Multistate_Output_Object(uint32_t object_instance)
{
    return Keylist_Data(Object_List, object_instance);
}

/**
 * @brief Determines the number of Multistate Output objects
 * @return  Number of Multistate Output objects
 * export
 */
...
int Multistate_Output_Read_Property(BACNET_READ_PROPERTY_DATA *rpdata)
{
    ...
    switch (rpdata->object_property) {
        ...
        case PROP_FEEDBACK_VALUE:
            present_value = pObject->Feedback_Value;
            apdu_len = encode_application_unsigned(&apdu[0], present_value);
            break;
#endif
    ...
    BACNET_GET_EVENT_INFORMATION_DATA * getevent_data)
{
    ...
    instance = Multistate_Output_Index_To_Instance(index);
